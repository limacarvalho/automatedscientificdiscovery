...
from app.ml.models.ensemble_v01 import BaseUnify
...
class AutoFit:
    def __init__(self, df_X, df_y, pred_class, retrain=False) -> None:
        ...
        self.slug_ann.pred_class = pred_class
        ...
        self.slug_ann.n_trials = 500

        self.slug_xgb = SlugXGBoost()
        self.slug_xgb.pred_class = pred_class
