...
apt install nano pciutils git r-base r-base-dev libgmp-dev libmpfr-dev -y
...
Rscript -e 'install.packages(c("base", "base64enc", "bit", "bit64", "boot", "class", "cluster", "codetools", "compiler", "CVXR", "datasets", "dbscan", "digest", "ECOSolveR", "evaluate", "fastcluster", "fastmap", "foreign", "glue", "gmp", "graphics", "grDevices", 
"grid", "highr", "htmltools", "htmlwidgets", "jsonlite", "KernSmooth", "knitr", "labdsv", "lattice", "magrittr", "maotai", "MASS", "Matrix", "mclustcomp", "methods", "mgcv", "minpack.lm", "nlme", "nnet", "osqp", "parallel", "R6", "RANN", "rbibutils", "Rcpp", 
"RcppArmadillo", "RcppDE", "RcppDist", "RcppEigen", "Rcsdp", "Rdimtools", "rdist", "Rdpack", "rgl", "rlang", "Rmpfr", "rpart", "RSpectra", "Rtsne", "scatterplot3d", "scs", "shapes", "spatial", "splines", "stats", "stats4", "stringi", "stringr", "survival", 
"tcltk", "tools", "utils", "xfun", "yaml"), repos="https://cloud.r-project.org")' | tee -a /opt/asd/asd-container-r-dependencies-installation-log.txt

# Clone the ASD git repository (excluding the 'container folder')
####### Read-only Git keys #######
export CI_DEPLOY_USER="gitlab+deploy-token-1651733"
export CI_DEPLOY_PASSWORD="jUZKE9xQWjsFxS3yU-2s"
##################################
git clone --depth 1 --filter=blob:none --sparse https://$CI_DEPLOY_USER:$CI_DEPLOY_PASSWORD@gitlab.com/automatedscientificdiscovery/python-asd.git
cd python-asd
