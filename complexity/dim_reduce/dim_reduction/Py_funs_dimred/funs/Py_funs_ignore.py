...
import numpy as np
    ...
    #         shuffle=True,
    #         dict_init=None,
    #         transform_algorithm='threshold', # updated 20221031 from default: 'omp',
    ...
    #         # 2) update 20221031: loss: 0.95; speed: slow; reduce as much as possible
    #         # 'alpha': [0.2, 2],  #
    #         # 'n_iter': [5, 150],  #
    #         # 'fit_algorithm': [0, 1],  #
    #          }
    ...
    #     hyperpars = {
    #         # 1) start with parameter ranges:
    #         # 'affinity': [0, 1],  # ‘ nearest_neighbors’,
    ...
    #
    #         # 2) update 20221031: loss: 0.826 speed: slow, reduce as much as possible
    #          # 'affinity': [0, 1],
    #          # 'gamma': [inv_feat/100, 1],
