...
class Py_helper:
    ...
    def exe_python_functions(self, params_py_dict: dict) -> (np.array, dict):
        ...
        of the dataset.
        :param params_py_dict: dict, parameters, values of hyperparameters of dim reduce function
        :return:(np.array, dict)  reduced data at target dimension, dictionary with hyperparameters
        '''
