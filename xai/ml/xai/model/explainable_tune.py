    ...
    def get_attr(self, attr_algos):                
        ...
        for base_model in self.ensemble_set.base_models:            
            ...
            for attr_algo in attr_algos:
                ...
                # elif (type(base_model.gs.best_estimator) == xgb.core.Booster) & (attr_algo == 'shap'):
                #         booster_type = json.loads(base_model.gs.best_estimator.save_config())['learner']['gradient_booster']['name']
