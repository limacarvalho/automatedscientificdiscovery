...
class BriskXGBoost:
    def __init__(self) -> None:
        ...
        self.temp_path = config.main_dir + config.project_name + "/tmp/xgboost/brisk"
        self.model_save_path = config.main_dir + config.project_name  + "/base/xgboost/brisk"
    ...
    def __discover_model__(self):
        ...
        customlogger.info('brisk xgboost: Starting train for trials:%d with boosted rounds: %d', self.n_trials, self.boosted_round)

        customlogger.info('brisk xgboost: Cleared previous models in the model save path')        
        ...
        customlogger.info('brisk xgboost: Number of trials: %d', len(study.trials))
