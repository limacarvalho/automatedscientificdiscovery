...
def get_covid_dataset():
    df = pd.read_csv('/mnt/c/Users/rwmas/GitHub/xai/python-asd/doc/relevance/covid/20220319_covid_merge_processed.csv', sep=",")
...
def get_tokamat_dataset():
    ...
    print(base_path)
    # HDB5.2.3_nans.csv,
    path = ('/mnt/c/Users/rwmas/GitHub/xai/python-asd/doc/relevance/tokamak/HDB5.2.3_no_nans.csv')#.resolve()
