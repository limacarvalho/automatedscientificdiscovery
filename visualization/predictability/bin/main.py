...
if __name__ == "__main__":
    ...
    metrics, datas = predictability(data_df, input_cols=input_cols_, output_cols=output_cols_, col_set=col_set_,
                                    primkey_cols=primkey_cols_, targets=target_set, method=method_, scoring=scoring_,
                                    n_jobs=n_jobs_, verbose=1, random_state_split=1)
